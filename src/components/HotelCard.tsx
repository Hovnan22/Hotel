            ...
            <View style={styles.description}>
                ...
                <View style={[styles.rowBox, styles.spaceBetween]}>
                    <View style={styles.spaceAround}>
                        <HBodyS text={dolar.repeat(hotel.priceCategory)} style={styles.priceBoxTitleActive} >
                            <HBodyS style={styles.priceBoxTitleInactive} text={dolar.repeat(maxPriceCategory - hotel.priceCategory)}/>
                        </HBodyS>
